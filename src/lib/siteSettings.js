...
export const DEFAULT_SITE_SETTINGS = {
  ...
  disableAllOficiales: false, // Permite al admin ocultar TODA la sección de material oficial de Biblioteca de golpe
...
// Interruptor maestro: oculta/restaura TODA la sección de material oficial de Biblioteca de golpe.
// Respeta los ocultos individuales al restaurar (no los toca).
export const setOficialesHiddenAll = async (hidden) => {
  return saveSiteSettings({ disableAllOficiales: Boolean(hidden) });
};
