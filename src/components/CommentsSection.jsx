          ...
          >
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: '0.82rem', color: 'var(--text-main)', lineHeight: 1.4 }}>
                💡 <strong>Tip RASTRO:</strong> Si escribes <em>"video 1 de literatura"</em> o <em>"clase 2 de biología"</em>, se convertirá automáticamente en un enlace directo al video. También puedes usar el botón <strong>"Vincular Clase"</strong>.
              </p>
            </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', maxHeight: '420px', overflowY: 'auto', paddingRight: '4px' }}>
                {comments.map(c => {
                  const isMyComment = user && (
                    ...
                    user.uid === c.ownerId ||
                    (user.email && (user.email === c.authorEmail || user.email === c.userEmail || user.email === c.ownerEmail))
                  );
                  // SEGURIDAD: poder de moderación solo por admin verificado (contexto o correo del autor).
                  // Nunca por campos del propio documento (cualquiera podría editarlos).
