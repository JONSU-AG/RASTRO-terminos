  ...
  if (showFrame && (frameConfig?.type === 'conic_flame' || resolvedFrameKey === 'creator_custom')) {
    ...
    return (
      <div 
        ...
        title={!disableLink ? `Ver perfil de ${nameToUse || 'Usuario'}` : "👑 Marco VIP Creador de Fuego RASTRO"}
      >
        <div 
  ...
  if (showFrame && frameConfig?.type === 'conic_rainbow') {
    ...
    return (
      <div 
        ...
        title={!disableLink ? `Ver perfil de ${nameToUse || 'Usuario'}` : "🌈 Marco Arcoíris Neón RASTRO"}
      >
...
export const LiveUserName = ({ uid, fallbackName = 'Estudiante RASTRO', style = {}, className = '' }) => {
