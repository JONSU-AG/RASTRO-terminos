...
export const SettingsModal = ({ isOpen, onClose, onOpenTerms }) => {
  ...
  const [notificationsEnabled, setNotificationsEnabled] = useState(() => {
    return localStorage.getItem('rastro_notifications_enabled') === 'true' || 
    ...
    if (typeof Notification !== 'undefined') {
      if (Notification.permission === 'default') {
        ...
        if (perm === 'granted') {
          ...
          localStorage.setItem('rastro_notifications_enabled', 'true');
        } else {
          setNotificationsEnabled(false);
          localStorage.setItem('rastro_notifications_enabled', 'false');
        }
      } else if (Notification.permission === 'granted') {
        const next = !notificationsEnabled;
        setNotificationsEnabled(next);
        localStorage.setItem('rastro_notifications_enabled', String(next));
      } else {
        alert("Las notificaciones están bloqueadas en tu navegador/dispositivo. Puedes activarlas desde la configuración de tu navegador.");
        setNotificationsEnabled(false);
      }
    } else {
      const next = !notificationsEnabled;
